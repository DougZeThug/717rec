...
| Browser back or forward | Steps to the previously opened section, or out of the dashboard from the first one. | Same as navigating away. Coming back gives a closed, empty form. |
