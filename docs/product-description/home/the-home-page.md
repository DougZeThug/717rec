...
| Weekly Recap       | The league has published an edition, **or** there was an upset, a streak, or a mover | The newest published edition, or — with none — the week's results live |
...
The Weekly Recap block prefers a **published edition** when the league has made
one. A published edition is frozen: it shows what was true at the end of that
week and does not drift as later results come in. It carries a link to its own
page at `/recap/<season>/week-<n>`. With nothing published, the block falls back
to the live reading it has always shown, which is also what unpublishing an
edition restores.
...
- **The "Confirm your team" card answers for the reader's own team only.** It is
  drawn when a season is open for confirmation _and_ the reader has an approved
