...
export type IconName = 
  // Navigation
  | "award" | "calendar" | "users" | "chevron-right" | "chevron-left" | "chevron-down" | "chevron-up"
  | "arrow-left" | "arrow-right" | "home" | "menu" | "x"
  // Actions  
  | "save" | "edit" | "trash" | "plus" | "minus" | "check" | "copy" | "download" | "upload"
  | "refresh-cw" | "settings" | "log-out" | "log-in" | "external-link"
  // Status
  | "alert-circle" | "check-circle" | "info" | "alert-triangle" | "loader-2"
  // Content
  | "trophy" | "medal" | "star" | "flag" | "target" | "crown" | "flame" | "zap"
  // Data
  | "search" | "filter" | "sort-asc" | "sort-desc" | "list" | "grid" | "table"
  // Social
  | "message-circle" | "heart" | "share" | "bookmark"
  // Misc
  | "eye" | "eye-off" | "lock" | "unlock" | "sun" | "moon" | "snowflake";
