...
import {
  // Navigation
  Award, Calendar, Users, ChevronRight, ChevronLeft, ChevronDown, ChevronUp,
  ArrowLeft, ArrowRight, Home, Menu, X,
  // Actions
  Save, Edit, Trash, Plus, Minus, Check, Copy, Download, Upload,
  RefreshCw, Settings, LogOut, LogIn, ExternalLink,
  // Status
  AlertCircle, CheckCircle, Info, AlertTriangle, Loader2,
  // Content
  Trophy, Medal, Star, Flag, Target, Crown, Flame, Zap,
  // Data
  Search, Filter, ArrowUpAZ, ArrowDownAZ, List, Grid2X2, Table,
  // Social
  MessageCircle, Heart, Share, Bookmark,
  // Misc
  Eye, EyeOff, Lock, Unlock, Sun, Moon, Snowflake,
} from "lucide-react";
