...
export const updateMatchInDatabase = async (
  ...
  const parsedTeam1GameWins = Number.isInteger(team1GameWins)
    ? team1GameWins
    : parseInt(String(team1GameWins)) || 0;
  const parsedTeam2GameWins = Number.isInteger(team2GameWins)
    ? team2GameWins
    : parseInt(String(team2GameWins)) || 0;
