...
describe('updateMatchScore', () => {
  ...
  const createMockChain = (matchData: any, updateData: any, matchError: any = null, updateError: any = null) => {
  ...
  it('does not fail when badge processing fails', async () => {
    vi.mocked(BadgeProcessingService.processMatchBadges).mockRejectedValueOnce(new Error('Badge error'));
