  ...
  return (
    <HelpAccordionItem value="standings" icon={BarChart3} title="Viewing Standings & Stats">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <strong>Power Score:</strong> A composite ranking that factors in win percentage and
          strength of schedule.
        </li>
        <li>
          <strong>SOS (Strength of Schedule):</strong> Measures the difficulty of opponents faced.
        </li>
        <li>
