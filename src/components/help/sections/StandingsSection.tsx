    ...
    <HelpAccordionItem value="standings" icon={BarChart3} title="Viewing Standings & Stats">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          ...
          match win rate, {weights.sos}% strength of schedule, and {weights.game}% game win rate.
          Wins and games are weighted by the division of the opponent you played, so beating a
          stronger team is worth more than beating a weaker one.
        </li>
        <li>
