  ...
  return (
    <HelpAccordionItem value="teams" icon={Users} title="Team Pages">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <strong>Stats Tab:</strong> Win/loss record, power score, and season performance
        </li>
        <li>
          <strong>Matches Tab:</strong> Complete match history with scores
        </li>
        <li>
          <strong>H2H Tab:</strong> Head-to-head records against other teams
        </li>
        <li>
