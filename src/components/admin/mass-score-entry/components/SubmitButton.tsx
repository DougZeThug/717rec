...
const SubmitButton: React.FC<SubmitButtonProps> = ({
  ...
  return (
    <div className="transition-transform active:scale-[0.97] w-full sm:w-auto">
      <Button
        onClick={onClick} // Wired to onClick prop
        disabled={disabled}
        className="w-full sm:w-auto flex items-center justify-center gap-2 transition-colors duration-200 hover:bg-opacity-90 shadow-xs"
      >
