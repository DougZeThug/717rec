...
import { hasVisibleMovers } from './weeklyRecapMovers';
...
const WeeklyRecapCard: React.FC<WeeklyRecapCardProps> = ({ data, risers, faller }) => {
  ...
  const hasMovers = hasVisibleMovers(risers, faller);
  ...
  return (
    ...
    >
      ...
      <CardContent className="relative p-3 md:p-6 space-y-3 md:space-y-5">
        ...
        {hasUpsets && hasStreaks && <div className="hidden md:block border-t border-border/50" />}
