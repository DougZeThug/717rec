...
describe('skeleton to content transitions', () => {
  it('transitions RecentMatchesSkeleton to RecentMatches', () => {
    ...
    rerender(<RecentMatches completedMatches={[sampleMatch]} getTeamById={(id): Team => ({ ...sampleTeam, id, name: id })} formatDate={() => ''} formatTime={() => ''} />);
  ...
  it('transitions WeeklyRecapSkeleton to WeeklyRecapCard', () => {
    ...
    rerender(<MemoryRouter><WeeklyRecapCard data={recapData} risers={[recapRiser]} /></MemoryRouter>);
