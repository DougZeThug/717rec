        ...
        <div className="flex sm:hidden items-center gap-1 text-sm mt-1">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-0.5 text-muted-foreground hover:text-foreground">
              Sort: <span className="text-foreground font-medium">{sortMode === 'rank' ? 'Rank' : 'A-Z'}</span>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-0.5 text-muted-foreground hover:text-foreground">
              View: <span className="text-foreground font-medium">{displayMode === 'grouped' ? 'By Division' : 'All'}</span>
              <ChevronDown className="h-3 w-3" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="start">
              <DropdownMenuItem onClick={() => setDisplayMode('grouped')}>By Division</DropdownMenuItem>
        ...
        <div className="hidden sm:flex flex-wrap gap-3 mt-2 sm:mt-0">
          ...
          <div className="inline-flex rounded-lg bg-muted p-0.5 shadow-sm">
            <button
              ...
              className={cn(
                "px-3 py-1 text-sm rounded-md transition-all",
                displayMode === 'all' ? "bg-primary text-primary-foreground" : "hover:bg-muted-foreground/10"
              )}
            >
              All Teams
            </button>
            <button
              ...
              className={cn(
                "px-3 py-1 text-sm rounded-md transition-all",
                displayMode === 'grouped' ? "bg-primary text-primary-foreground" : "hover:bg-muted-foreground/10"
              )}
            >
              By Division
            </button>
