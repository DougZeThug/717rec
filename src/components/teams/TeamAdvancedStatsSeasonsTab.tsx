...
export const TeamAdvancedStatsSeasonsTab = (props: TeamAdvancedStatsSeasonsTabProps) => [
  <TeamAdvancedStatsSummaryCards key="summary" advancedStats={props.advancedStats} />,
  <SeasonsTable key="table" {...props} />,
];
