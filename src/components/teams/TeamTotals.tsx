...
import { Trophy, Award, Target, TrendingUp, Zap, Scale, Wind, ChevronDown, BarChart } from "lucide-react";
      ...
      <div className="border rounded-lg bg-card shadow-sm">
        <CollapsibleTrigger className="flex items-center justify-between w-full p-3 md:p-4 hover:bg-accent/50 transition-colors">
          <div className="flex items-center gap-2">
            <BarChart className="h-4 w-4 md:h-5 md:w-5 text-purple-500" />
        ...
        <CollapsibleContent>
          <div className="p-3 md:p-4 pt-0 border-t">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 md:gap-6 pt-3">
