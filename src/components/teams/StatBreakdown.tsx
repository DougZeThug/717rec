            ...
            >
              ...
              <TabsContent value="advanced" className="space-y-4">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                  ...
                  >
                    <CollapsibleTrigger className="flex items-center justify-center w-full py-2 text-sm font-medium text-muted-foreground hover:bg-accent dark:hover:bg-gray-800 rounded-md transition-colors">
