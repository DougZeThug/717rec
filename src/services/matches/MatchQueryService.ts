...
/**
 * Core match fetch queries — team details, filters, pagination, and scheduling helpers.
 */
...
// ---------------------------------------------------------------------------
// Scheduling helpers — moved from utils/autoSchedule (Batch 11 refactor)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Season opponent history — used by useSeasonOpponentHistory hook
// ---------------------------------------------------------------------------
