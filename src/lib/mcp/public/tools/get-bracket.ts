...
export default defineTool({
  ...
  handler: async ({ bracketId, division }) => {
    ...
    let roundRows: { data: typeof roundRowsT | null; error: { message: string } | null } = { data: [], error: null };
    let matchRows: { data: typeof matchRowsT | null; error: { message: string } | null } = { data: [], error: null };
