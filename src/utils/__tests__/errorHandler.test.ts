...
describe('isServiceError', () => {
  ...
  it('returns false for plain Error and non-errors', () => {
    const missingError: { value: unknown } = { value: undefined };
    ...
    expect(isServiceError(missingError.value)).toBe(false);
  });
});
...
describe('getErrorMessage', () => {
  ...
  it('returns fallback for non-error values', () => {
    ...
    expect(getErrorMessage(missingError.value)).toBe('An unknown error occurred');
...
describe('convertErrorToString', () => {
  it('returns null when error is null or undefined', () => {
    ...
    expect(convertErrorToString(missingError.value)).toBeNull();
  });
