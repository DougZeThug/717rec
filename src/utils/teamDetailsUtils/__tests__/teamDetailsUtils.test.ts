...
describe('teamDetails utilities', () => {
  ...
  it('classifies rivalries and maps label/type thresholds', () => {
    ...
    const rivalryCases: Array<{
      record: HeadToHeadRecord;
      expected: ReturnType<typeof getRivalryType>;
    }> = [
      {
        record: {
          team_id: 'team-a',
    ...
    expect(getRivalryLabel('nemesis', 'Opponent', { wins: 1, losses: 4, matches_played: 5 })).toBe(
      'Opponent is 1-4 all-time'
    );
