...
describe('color modules table-driven coverage', () => {
  ...
  it.each([
    { fn: getDivisionGradientClass, input: 'Competitive', fragment: 'via-[hsl(var(--competitive-soft)/0.06)]' },
    { fn: getDivisionHeaderClass, input: 'Intermediate', fragment: 'border-[hsl(var(--intermediate-soft)/0.35)]' },
    { fn: getDivisionTextClass, input: 'Recreational', fragment: 'text-[hsl(var(--recreational-soft))]' },
    { fn: getDivisionBadgeColor, input: 'Hidden', fragment: 'bg-[hsl(var(--competitive-soft)/0.15)]' },
