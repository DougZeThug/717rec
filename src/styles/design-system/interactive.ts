...
export const interactive = {
  ...
  link: {
    default:
      'text-cornhole-navy hover:text-cornhole-navy/80 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200',
  ...
  button: {
    ...
    pressed:
      'active:scale-[0.97] active:bg-foreground/5 dark:active:bg-foreground/10 transition-all duration-100',
  },
  ...
  row: {
    ...
    pressed:
      'active:scale-[0.99] active:bg-accent/10 dark:active:bg-accent/15 transition-all duration-100',
    // Combined hover + pressed for list items
    interactive:
      'hover:bg-muted/50 active:scale-[0.99] active:bg-accent transition-all duration-100 cursor-pointer',
  },
  ...
  tab: {
    ...
    interactive:
      'hover:bg-accent/50 active:scale-[0.98] active:bg-accent/30 transition-all duration-100',
  },
