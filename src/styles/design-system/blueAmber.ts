...
export const blueAmber = {
  ...
  text: {
    ...
    headingSubtle:
      'bg-gradient-to-br from-blue-500/90 to-amber-500/80 bg-clip-text text-transparent heading-winter',
    accent:
      'bg-gradient-to-br from-blue-700 to-amber-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-amber-400 heading-winter',
  },
  ...
  border: {
    ...
    accent:
      'border-l-4 border-gradient-to-b from-blue-500 to-amber-500 dark:from-blue-600 dark:to-amber-600',
  ...
  background: {
    ...
    section:
      'bg-gradient-to-br from-blue-50/50 via-white to-amber-50/20 dark:from-gray-800/80 dark:via-gray-800/90 dark:to-gray-900',
    hover:
      'hover:bg-gradient-to-br hover:from-blue-50/40 hover:to-amber-50/20 dark:hover:from-gray-800/90 dark:hover:to-gray-700/80',
  },

  // Interactive elements gradients (buttons, toggles, etc)
  interactive: {
    active:
      'bg-gradient-to-br from-blue-600 to-amber-600 text-white dark:from-blue-600 dark:to-amber-700 dark:text-white',
    hover:
      'hover:bg-gradient-to-br hover:from-blue-500/10 hover:to-amber-500/5 dark:hover:from-blue-900/10 dark:hover:to-amber-900/5',
  ...
  card: (className?: string, options?: { accent?: boolean; hover?: boolean }) => {
    return cn(
      ...
      options?.hover &&
        'transition-all duration-300 hover:shadow-md hover:bg-gradient-to-br hover:from-blue-50/30 hover:to-amber-50/20 dark:hover:from-gray-800/80 dark:hover:to-gray-900/90',
      className
    );
  },
};
