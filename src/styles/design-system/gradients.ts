...
export const gradients = {
  ...
  card: {
    ...
    division: {
      competitive:
        'bg-gradient-to-br from-white to-orange-50 dark:from-gray-800/90 dark:to-gray-900/70',
      intermediate:
        'bg-gradient-to-br from-white to-blue-50 dark:from-gray-800/90 dark:to-gray-900/70',
      recreational:
        'bg-gradient-to-br from-white to-green-50 dark:from-gray-800/90 dark:to-gray-900/70',
    },
    elevated:
      'bg-gradient-to-br from-white to-gray-50 shadow-lg dark:from-gray-800 dark:to-gray-900',
    interactive:
      'bg-gradient-to-br from-white to-gray-50 hover:from-gray-50 hover:to-gray-100 transition-all duration-300 dark:from-gray-800 dark:to-gray-900 dark:hover:from-gray-800/90 dark:hover:to-gray-800',
    // New orange accent gradients
    orangeAccent: 'bg-gradient-to-br from-white to-orange-50 dark:from-gray-800 dark:to-gray-900',
    orangeHighlight:
      'bg-gradient-to-br from-white to-orange-100/80 dark:from-gray-800 dark:to-gray-900/90',
    blueOrange:
      'bg-gradient-to-br from-white via-blue-50/30 to-orange-50/40 dark:from-gray-800 dark:to-gray-900',
    statHighlight:
      'bg-gradient-to-br from-white via-blue-50/20 to-orange-50/30 dark:from-gray-800 dark:to-gray-900/80',
  },
  ...
  section: {
    ...
    orangeAccent:
      'bg-gradient-to-br from-orange-50 to-orange-100/70 dark:from-gray-800 dark:to-gray-900/90',
    blueOrangeSubtle:
      'bg-gradient-to-br from-blue-50 via-white to-orange-50/30 dark:from-gray-800/90 dark:via-gray-800 dark:to-gray-900',
    ctaOrange:
      'bg-gradient-to-br from-orange-100/80 to-amber-200/60 dark:from-amber-900/20 dark:to-gray-900',
  },

  // Interactive elements
  interactive: {
    hover:
      'transition-all duration-200 hover:bg-gradient-to-br hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-700',
    hoverPrimary:
      'transition-all duration-200 hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-700 hover:text-white',
    // New interactive gradients with orange accents
    orangeHover:
      'transition-all duration-200 hover:bg-gradient-to-br hover:from-orange-50/70 hover:to-orange-100/50 dark:hover:from-amber-900/10 dark:hover:to-amber-800/5',
    orangeActive:
      'active:bg-gradient-to-br active:from-orange-100 active:to-orange-200/80 dark:active:from-amber-900/20 dark:active:to-amber-800/10',
  },
  ...
  tab: {
    ...
    division: {
      competitive:
        'bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/10',
      intermediate:
        'bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/10',
      recreational:
        'bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/10',
    },
    // New tab backgrounds with orange accents
    activeOrange:
      'bg-gradient-to-br from-white to-orange-100/70 dark:from-gray-700 dark:to-gray-800',
    inactiveOrange:
      'bg-gradient-to-br from-orange-50/50 to-gray-100 dark:from-gray-800 dark:to-gray-900',
  },
};
