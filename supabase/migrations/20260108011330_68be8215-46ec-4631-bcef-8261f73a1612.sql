...
--
-- 20260107151848 (10 hours earlier) already created
-- season_team_participation (with CREATE TABLE IF NOT EXISTS, plus the
-- updated_at trigger and RLS policies). This regeneration uses a plain
-- CREATE TABLE, which errors with "already exists" once the first file has
-- applied, so it always aborted.
