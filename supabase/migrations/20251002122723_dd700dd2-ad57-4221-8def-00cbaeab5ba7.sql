-- Fix Security Definer View issue by adding security_invoker option
-- This ensures views execute with the permissions of the querying user, not the view creator
-- Affected views: v_team_details, v_team_details_with_season, v_team_power_scores, v_team_season_agg
...
-- Recreate dependent views that were dropped with security_invoker
