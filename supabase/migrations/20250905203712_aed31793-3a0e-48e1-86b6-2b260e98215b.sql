-- Fix security issue by ensuring view uses invoker's permissions
DROP VIEW IF EXISTS public.v_head_to_head;

CREATE VIEW public.v_head_to_head 
SECURITY INVOKER AS
WITH all_matches AS (
  ...
  SELECT
    ...
    pm.winner_id,
    pm.loser_id,
    -- Use match scores as game wins for playoff matches
    CASE WHEN pm.winner_id = pm.team1_id THEN pm.team1_score ELSE 0 END as team1_game_wins,
    CASE WHEN pm.winner_id = pm.team2_id THEN pm.team2_score ELSE 0 END as team2_game_wins,
