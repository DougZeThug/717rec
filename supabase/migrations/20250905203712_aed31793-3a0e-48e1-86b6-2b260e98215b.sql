...
--
-- "CREATE VIEW ... SECURITY INVOKER AS" is not valid Postgres syntax (the
-- real form is WITH (security_invoker = true)), so this file always errored
-- and its transaction aborted. 20250905203749_b9783b6e (37 seconds later) is
-- the working rewrite with a plain CREATE VIEW.
