...
-- Update v_team_details view to set power_score to NULL for teams with no matches
...
LEFT JOIN (
    -- UPDATED: 40/40/20 POWER SCORE FORMULA - return NULL for teams with no matches
    SELECT 
        t.id as team_id,
        CASE 
