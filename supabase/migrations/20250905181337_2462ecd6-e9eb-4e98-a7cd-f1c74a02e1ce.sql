...
--
-- The inner "SELECT * FROM matches UNION ALL SELECT * FROM matches_archive"
-- requires both tables to have identical column lists, but matches_archive
-- has the extra archived_at column, so this always errored and the file's
-- transaction aborted. 20250905181443/20250905181458 are the working
-- rewrites using explicit column lists. Original text kept below for history.
