...
-- Drop the v_team_details view and its dependencies, then recreate them with division-based SOS
DROP VIEW IF EXISTS public.v_team_details CASCADE;

-- Recreate v_team_details with division-based SOS calculation
