...
--
-- This is a self-test script for the trigger installed by
-- 20260112200000_sync_match_to_playoff_matches.sql. Its test-data setup runs
-- INSERT INTO round (group_id, number, name) without stage_id, but
-- 20251022202853 had added stage_id NOT NULL to round, so the script
-- always failed its NOT NULL constraint and aborted — on any database. It
-- was committed to the repo but can never have completed a run.
